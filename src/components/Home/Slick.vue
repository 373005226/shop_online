<template>
  <div class="Slick" :style="{width:(showWidth+btnWidth*2+20)+'px',height:height+'px'}">
    <div class="prev" @click="prev"
         :style="{width:btnWidth+'px',height:btnWidth+'px',lineHeight:btnWidth+'px',opacity:curPage<=1?0.3:1}"><i
      class="el-icon-arrow-left"/></div>
    ...
    <div class="next" @click="next"
         :style="{width:btnWidth+'px',height:btnWidth+'px',lineHeight:btnWidth+'px',opacity:curPage>=pageNum?0.3:1}"><i
      class="el-icon-arrow-right"/></div>
  </div>
</template>
